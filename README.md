<p align="center">
  <a href="https://xray.wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=514-7" alt="Wickra X-Ray — a free explorer for market microstructure — footprint, order-book heatmap, liquidation map, funding/OI divergence" width="100%"></a>
</p>

[![Built on Wickra](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-xray-site/built-on.svg)](https://github.com/wickra-lib/wickra)
...
[![Built with VitePress](https://raw.githubusercontent.com/wickra-lib/.github/main/profile/badges/wickra-xray-site/vitepress.svg)](https://vitepress.dev)

---

Source for the Wickra X-Ray site (**[xray.wickra.org](https://xray.wickra.org)**): hero, per-language API overviews, benchmarks and the in-browser indicator demo.
...
**Wickra X-Ray** — a free explorer for market microstructure — footprint, order-book heatmap, liquidation map, funding/OI divergence. The library itself is
[`wickra-lib/wickra-xray`](https://github.com/wickra-lib/wickra-xray); its README carries the install line and a quick start for every language.
...
- **The released version** — the version menu in the nav, the Maven snippet on the landing page and the Java API page — is pulled hourly from [wickra-xray's latest release](https://github.com/wickra-lib/wickra-xray/releases/latest) by `sync-from-xray.yml`.
